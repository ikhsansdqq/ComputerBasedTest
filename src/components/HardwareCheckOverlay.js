            ...
            <div className="bg-white p-8 rounded shadow-md max-w-md mx-auto">
                ...
                <ul className="max-w-md space-y-2 text-gray-500 list-inside dark:text-gray-400">
                    <li className="flex items-center">
                        ...
                        {cameraAvailable ? 'Camera is available' : 'Camera is not available'}
                    </li>
                    <li className="flex items-center">
                ...
                {!isChecking && cameraAvailable && (
                    <button onClick={handleProceed} className="mt-4 px-4 py-2 bg-blue-500 text-white rounded">Proceed to Exam</button>
                )}
                {!isChecking && !cameraAvailable && (
