            ...
            <div className='relative flex justify-between'>
                <div className=' flex flex-col items-center gap-6'>
                        ...
                        <div className="">
                            <div className="p-8">
                                <div className="flex justify-between items-center w-full">
                                    <div className=" text-[24px] text-black font-semibold">Client Information</div>
                    ...
                    <div className=" bg-white rounded-xl  border w-full">
                        <div className="">
                            <div className="p-8">
                                <div className="flex justify-between items-center w-full">
                                    <div className=" text-[24px]  font-semibold">Machine Learning Information</div>
                ...
                <div className='w-[704px]'>
                    ...
                    <div className='flex flex-col gap-6 mb-6'>
                        <p className={`font-medium text-[${valueFontSize}px] leading-[${valueLineHeight}] tracking-[${valueLetter}%]`}>Describe the process of how a basic cryptographic system works, including the roles of encryption and decryption, keys, and algorithms. Illustrate your answer with an example of how data is encrypted and decrypted using both symmetric and asymmetric key encryption. Finally, explain the challenges associated with key management and distribution in cryptographic systems.</p>
                        <Image src={Soal1} />
                        <p className={`font-medium text-[${valueFontSize}px] leading-[${valueLineHeight}] tracking-[${valueLetter}%]`}>Asymmetric Key Encryption: Uses a pair of keys – a public key for encryption and a private key for decryption. The public key can be shared openly, but the private key must be kept secure.</p>
                        <p className={`font-medium text-[${valueFontSize}px] leading-[${valueLineHeight}] tracking-[${valueLetter}%]`}>Which property of a cryptographic system ensures that a message cannot be altered without detection?</p>
                    </div>
                    <p className='font-medium text-[20px] leading-8 tracking-[2.5%] italic text-[#5D5D5D] mb-5'>Select one answer</p>
                    <div className='flex flex-col gap-3'>
                        <div className="flex items-center px-6 py-4 rounded-lg border">
                            ...
                            <label for="default-radio-1" className="ms-2 text-[18px] font-medium leading-6 tracking-[2.5%] ">Binary Tree</label>
                        </div>
                        <div className="flex items-center px-6 py-4 rounded-lg border">
                            ...
                            <label for="default-radio-2" className="ms-2 text-[18px] font-medium leading-6 tracking-[2.5%] ">Neural Network</label>
                        </div>
                        <div className="flex items-center px-6 py-4 rounded-lg border">
                            ...
                            <label for="default-radio-3" className="ms-2 text-[18px] font-medium leading-6 tracking-[2.5%] ">Blockchain</label>
                        </div>
                        <div className="flex items-center px-6 py-4 rounded-lg border">
                            ...
                            <label for="default-radio-4" className="ms-2 text-[18px] font-medium leading-6 tracking-[2.5%] ">Quantum Circuit</label>
                        </div>
                    </div>
                    <button className='py-3 px-[42px] bg-black text-white w-fit rounded-lg my-[52px]'>Next</button>
                </div>
            </div>
        </div>
    )
