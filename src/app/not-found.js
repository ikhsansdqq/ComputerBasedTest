...
const NotFoundPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white border rounded-lg overflow-hidden flex max-w-4xl w-full">
        {/* Left Side */}
        <div className="w-1/2 p-8">
          <Image width={240} height={240} src="/figma-logo.png" alt="Figma Logo" className="h-12 w-12 mb-6 rounded border" />
          ...
          <Link href='/'><button className='mt-8 w-full px-4 py-3 rounded text-white bg-blue-600 hover:shadow-md hover:bg-blue-700 transition duration-300'>Back to home</button></Link>
        </div>
        ...
        <div className="w-1/2 p-8 bg-gray-50">
          ...
          <div className="space-y-4">
            {articles.map((article, index) => (
              <div key={index} className="bg-white p-4 rounded border cursor-pointer hover:shadow-sm duration-200 transition">
